              ...
              <div id="header_<?=$v->id;?>" class="card-header <?=$bg;?> shadow-sm border-0">
                ...
                <h6>
                  ...
                  if($this->session->userdata('id_roles')!=3){
                      if($v->status == 0){
                        echo '<button  class="btn btn-primary btn-xs float-right mr-2" style="margin-top:2px; margin-bottom:2px; color: white;" onclick="tambah_dt('.$v->id.',1,0)"><i class="fa fa-plus"></i> Tambah</button>';
                      }
                      if($v->status == 0){
                    ...
                    <div id="detail_<?=$val->detail_id;?>" class="card-header bg-white shadow-sm border-0">
                      <h6> 
                        ...
                        <?php }
                          if($val->child==0){
                            if($v->status==0){
                              echo ' <a href="javascript:;" class="btn btn-info btn-xs float-right" style="margin-top:2px; margin-bottom:2px;" onclick="editData_dt('.$val->detail_id.',1)"><i class="fas fa-pencil-alt"></i> Edit </a> ';
                            }
                          }
                          if($v->status==0){
                            echo '<button  class="btn btn-primary btn-xs float-right mr-2" style="margin-top:2px; margin-bottom:2px; color: white;" onclick="tambah_dt('.$v->id.',2,'.$val->detail_id.')"><i class="fa fa-plus"></i> Tambah</button>';
                          }
                        ?>
                      ...
                      <div class="card-body p-3">
                        ...
                        <div class="card">
                          <div id="detailed_<?=$vd->id;?>" class="card-header bg-white shadow-sm border-0">
                            <h6>
                              <?php
                                echo ' <a href="javascript:;" class="btn btn-info btn-xs float-right" style="margin-top:2px; margin-bottom:2px;" onclick="editData_dt('.$vd->id.',2)"><i class="fas fa-pencil-alt"></i> Edit </a> ';
                              ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="eventInsForm" method="post" target="_self" name="dt_frmInv" 
                    ...
                    <input type="hidden" id="dt_level" name="dt_level">
                    <div class="row mb-1">
                        <div class="col-md-4">
                            Task Number
                        </div>
                    ...
                    <div class="row mb-1 show_detail" style="display: none;">
                        <div class="col-md-4">
                            PIC<font color="#f00">*</font>
                        </div>
                        <div class="col-md-8">
                    ...
                    <div class="row mb-1 show_detailed" style="display: none;">
                        <div class="col-md-4">
                            PIC<font color="#f00">*</font>
                        </div>
                        <div class="col-md-8">
                    ...
                    <div class="row mb-1">
                        ...
                        <div class="col-md-8">
                          <textarea rows="5" class="form-control" name="dt_notes" id="dt_notes"></textarea>
                        </div>
                    </div>
                    <div class="row mb-1">
                        <div class="col-md-4">
...
function tambah_dt(task_id,level,parent_id){
  dsStateDetail = "Input";
  if(level==2){
    $('.show_detailed').show();
    $('.show_detail').hide();
  ...
  $('#dt_task_parent_id').val(parent_id);
  $('#dt_tanggal_dt').val('');
